  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center font-sans selection:bg-secondary/30 relative">
      <Link to="/auth" className="flex flex-col items-center justify-center group cursor-pointer z-10 w-full h-full absolute inset-0">
        ...
        >
          {/* Logo Box */}
          <div className="w-[180px] h-[180px] sm:w-[220px] sm:h-[220px] bg-white rounded-[40px] sm:rounded-[48px] flex items-center justify-center shadow-[0_8px_30px_rgba(0,0,0,0.08)] mb-6 sm:mb-8 group-hover:scale-105 transition-transform duration-300 border border-slate-50 relative overflow-hidden">
