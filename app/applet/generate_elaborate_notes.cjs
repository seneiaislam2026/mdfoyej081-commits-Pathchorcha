...
const elaborateContents = {
  ...
  "m-1-c-5": {
    "intro": "সবচেয়ে বড় ও গুরুত্বপূর্ণ অধ্যায় হলো 'যৌথ মূলধনী ব্যবসায়'। কোম্পানি আইন, প্রকারভেদ, শেয়ার এবং স্মারকলিপি থেকে এখানে বিস্তারিত নোটস দেওয়া হলো।",
    "chapters": [
      {
  ...
  "m-1-c-8": {
    ...
    "chapters": [
      ...
      },
      {
        ...
        "items": [
          "👉 BSTI: Bangladesh Standards and Testing Institution. এটি শিল্প মন্ত্রণালয়ের অধীন এবং পণ্যের মান নিয়ন্ত্রণ করে।"
        ]
      }
    ]
  },
...
for(let id in elaborateContents) {
    ...
    const contentString = 'content: ' + JSON.stringify(noteData, null, 6);
...
// Ensure proper syntax for object keys
newCode = newCode.replace(/"intro":/g, 'intro:').replace(/"chapters":/g, 'chapters:').replace(/"title":/g, 'title:').replace(/"items":/g, 'items:');
